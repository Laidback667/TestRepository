...
<html>
    <head>
        ...
        <title>Suppression de message</title>
    </head>
    <body>
        <h1>Messages d'or :</h1>

        <form action ="ConfSuppression" method = "GET">
            ...
            <%
                ...
                if (Liste.isEmpty()) {
                    ...
                    for (int i = 0; i < Liste.size(); i++) {
                        ...
                        out.println("<tr>");
                        out.println("<td><input type=\"checkbox\" name = \"cb\" value = \"" + Liste.get(i).getId() + "\" " + isChecked(listeSuppr, Liste.get(i).getId() + "") + "></td>"); // rajouter "" à un int pour le transformer en String
